...
function intern(val) {
    inquirer.prompt(intern_question).then(extra => {
        ...
        let temporaryFile = templateFile.replace('{{name}}', varIntern.getName());
        temporaryFile = temporaryFile.replace('{{role}}', varIntern.getRole());
        temporaryFile = temporaryFile.replace('{{id}}', varIntern.getId());
        temporaryFile = temporaryFile.replace('{{email1}}', varIntern.getEmail());
        temporaryFile = temporaryFile.replace('{{email2}}', varIntern.getEmail());
...
function engineer(val) {
    ...
    inquirer.prompt(engineer_questions).then(extra => {
        ...
        let temporaryFile = templateFile.replace('{{id}}', varEng.getId());
        temporaryFile = temporaryFile.replace('{{name}}', varEng.getName());
        temporaryFile = temporaryFile.replace('{{role}}', varEng.getRole());
        temporaryFile = temporaryFile.replace('{{email1}}', varEng.getEmail());
        temporaryFile = temporaryFile.replace('{{email2}}', varEng.getEmail());
...
function manager(val) {
    inquirer.prompt(managers_questions).then(extra => {
        ...
        temporaryFile = temporaryFile.replace('{{id}}', varMan.getId());
        temporaryFile = temporaryFile.replace('{{email1}}', varMan.getEmail());
        temporaryFile = temporaryFile.replace('{{email2}}', varMan.getEmail());
